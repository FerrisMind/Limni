      ...
      <div class="placeholder-content">
        ...
        <div class="quick-links">
          ...
          <div class="links-grid">
            <button class="link-card" onclick={() => openQuickLink('https://www.google.com', 'Google')}>
            ...
            <button class="link-card" onclick={() => openQuickLink('https://stackoverflow.com', 'Stack Overflow')}>
              <i class="ph ph-stack-overflow-logo link-icon stackoverflow-color"></i>
              <div class="link-title">Stack Overflow</div>
            </button>
            
            <button class="link-card" onclick={() => openQuickLink('https://www.youtube.com', 'YouTube')}>
