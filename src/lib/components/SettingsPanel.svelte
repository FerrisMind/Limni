...
{#if browserState.showSettings}
  <div class="settings-panel">
    <div class="panel-header">
      <h3>Настройки</h3>
      <button class="action-btn close-btn" onclick={closePanel} title="Закрыть" aria-label="Закрыть панель настроек">
        <i class="ph ph-x"></i>
      </button>
    </div>
      ...
      <div class="settings-section">
        ...
        <div class="setting-item">
          <label class="setting-checkbox">
            <input 
              type="checkbox" 
              bind:checked={settings.allowJavaScript}
            />
            <span class="checkbox-label">Разрешить JavaScript</span>
          </label>
          <p class="setting-description">
            Включает выполнение JavaScript на веб-страницах
          </p>
        </div>
        ...
        <div class="setting-item">
          <label class="setting-checkbox">
            <input 
              type="checkbox" 
              bind:checked={settings.allowImages}
            />
            <span class="checkbox-label">Загружать изображения</span>
          </label>
          <p class="setting-description">
            Автоматически загружать и отображать изображения
          </p>
        </div>
        ...
        <div class="setting-item">
          <label class="setting-checkbox">
            <input 
              type="checkbox" 
              bind:checked={settings.allowCookies}
            />
            <span class="checkbox-label">Разрешить cookies</span>
          </label>
          <p class="setting-description">
            Позволяет сайтам сохранять файлы cookie в приложении
          </p>
        </div>
      </div>
